        ...
        <div>
          ...
          <div className="mt-2 relative">
            <input
              ...
              className={`block w-full pr-10 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary/40 transition ${
                touched.name
                  ? validName
                    ? "border-green-300"
                    : "border-red-300"
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-2">
            <select
              ...
              className={`rounded-lg border p-3 pr-8 bg-white focus:outline-none focus:ring-2 focus:ring-primary/40 transition ${
                touched.grade
                  ? validGrade
                    ? "border-green-300"
                    : "border-red-300"
